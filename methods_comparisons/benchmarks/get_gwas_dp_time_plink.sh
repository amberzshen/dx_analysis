...
bash /mnt/project/amber/scripts/profile.sh $OUT_DIR/gwas_plink_chr${chrom}.csv \
    plink2 \
    --pfile ukb20279_c${chrom}_b0_v1_250129_whitelist \
...
bash /mnt/project/amber/scripts/profile.sh $OUT_DIR/dot_product_plink_chr${chrom}.csv \
    plink2 \
        --pfile ukb20279_c${chrom}_b0_v1_250129_whitelist \
        --score weights.txt list-variants \
        --out chr${chrom}_scores 
