...
#     -iin="/amber/scripts/get_gwas_dp_time_plink.sh" \
#     -icmd="bash get_gwas_dp_time_plink.sh 21" \
...
# dx run app-swiss-army-knife \
#     -iin="/amber/scripts/get_gwas_dp_time_plink.sh" \
#     -icmd="bash get_gwas_dp_time_plink.sh 11" \
#     --destination "/amber/methods_comparisons/results/" \
...
dx run app-swiss-army-knife \
    -iin="/amber/scripts/get_gwas_dp_time_plink.sh" \
    -icmd="bash get_gwas_dp_time_plink.sh 1" \
    --destination "/amber/methods_comparisons/results/" \
