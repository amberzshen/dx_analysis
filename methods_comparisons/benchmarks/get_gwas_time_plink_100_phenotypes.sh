...
python /mnt/project/amber/scripts/make_100_phenotypes.py
pheno_cols=$(awk 'NR==1 {for(i=3;i<=NF;++i) printf("%s%s", $i, (i<NF?",":"\n"))}' phenotypes.txt)
