...
linarg = ld.LinearARG(linear_arg_adjacency_matrix, sample_idx, merged_variant_indices, variants_flipped_ref_alt)
...
linarg.write(f'/mnt/project/linear_arg_results/{args.data_identifier}/linear_arg', chrom, positions, refs, alts)
