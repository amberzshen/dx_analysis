...
res_dir="lin_reg_benchmark/20mb_all"
...
for partition_id in "${partition_ids[@]:1}"
    do
        ...
        dx run app-swiss-army-knife \
            -iin="/amber/scripts/run_lin_reg_benchmark_20mb.sh" \
            -iin="/amber/scripts/lin_reg_benchmark_20mb.py" \
            -icmd="bash run_lin_reg_benchmark_20mb.sh $linarg_dir $partition_id $data_type $res_dir" \
            --destination "/" \
